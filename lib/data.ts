...
export const transportRoutes: TransportRoute[] = [
  ...
  },
  {
    ...
    stops: [
      ...
      { name: "Hidroeléctrica", time: "13:00", note: "Caminata o tren a Aguas Calientes" },
    ],
    highlights: [
...
export const transfers: Transfer[] = [
  ...
  {
    slug: "aeropuerto-arequipa-hotel",
  ...
  {
    slug: "cusco-valle-sagrado-hoteles",
